...
ORIGINAL_KEYS = {
    ...
    "TitleCardAddBlurEffect": "AddBlurEffect",
    "TitleCardtextBlurProfile": "textBlurProfile",
    "TitleCardglassColor": "glassColor",
    "TitleCardcolorize": "colorize",
...
CONFIG_GROUPS = {
    ...
    "TitleCardAddBlurEffect": "TitleCardOverlayPart",
    "TitleCardtextBlurProfile": "TitleCardOverlayPart",
    "TitleCardglassColor": "TitleCardOverlayPart",
    "TitleCardcolorize": "TitleCardOverlayPart",
    # TitleCardTitleTextPart
...
DISPLAY_NAMES = {
    ...
    "TitleCardAddBlurEffect": "TitleCard Blur effect",
    "TitleCardtextBlurProfile": "Strength of the background blur",
    "TitleCardglassColor": "Color and transparency of blur",
    "TitleCardcolorize": "Color saturation of blur",
    # Title Card Title Text
